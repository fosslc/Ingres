...
**      05-Jan-1993 (mikem)
**          su4_us5 6.5 port.  Changed cast of "fileno(fp) to a longnat from
...
**          Changed cast of "fileno(fp)" to "unsigned longnat" from
**          "longnat". Otherwise, for those machines that:
