...
/******************************************************************************
**
**  Name: MEFINDPAGES.ROC - Find a contiguous region of free memory
**
**  Description:
**	This file contains a table used to aid searching for contiguous
**	cleared bits.
**
