...
**	14-aug-1989 (kimman)
**	    Chaned message file names as per dev62cl #10027
**	04-apr-1990 (boba)
**	    File names redefined for this special 6.2 backwards compatability
**	    kludge.
**	29-nov-1990 (sandyd)
**	    This is an archived version of the old "v1" erloc.h taken from the 
**	    ingres6302p piccolo library (unix!cl!clf!er62!erloc.h r1.1).
**	    We use this to build an old "v1" version of ercompile so that 
**	    we can recreate "{fast,slow}_v1.mnx" files from source in new 
...
**	    from ercomp_v1.c has been removed.
**	21-jan-1999 (hanch04)
...
*/
/*===========================*/
#define		ER_FASTFILE	ERx("fast_v1.mnx")
#define		ER_SLOWFILE	ERx("slow_v1.mnx")
#define		ERx(c)		c
