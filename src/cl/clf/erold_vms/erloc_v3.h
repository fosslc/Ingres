...
**	    erloc.h).  This is used to build ercompile_v3 so that we can
**	    recreate the "{fast|slow}_v3.mnx" files from source in new
**	    releases.  The few definitions that were used by ercomp_v3.c from
**	    er.h have been moved into this file.
**	01-dec-2000	(kinte01)
...
*/
/*===========================*/
#define		ER_FASTFILE	ERx("fast_v3.mnx")
#define		ER_SLOWFILE	ERx("slow_v3.mnx")
#define		ERx(c)		c
...
*/
#define	ER_FASTSECT	ERx("II_FST3MSGS_")
