...
**	23-June-1994 (michael)
**	    Integrated new CI macros from JPK.
**	02-Feb-96 (rajus01)
**	    Add bit 60 for Protocol Bridge.
**	17-Sep-96 (mcgem01)
**	    Add bit 61 for Opal support.
**	19-Jun-97 (hanch04)
**	    Changed DIS_KEY for OI2.0
**	25-mar-1998 (canor01)
...
**	    returned from the CA-Licensing software.
**	11-sep-98 (mcgem01)
**	    Add a bit for ICE.
**	22-nov-2002 (mcgem01)
...
# define	CI_RMS_GATEWAY		34  /* not used - to be retired */
# define	CI_SS_STAR		35
# define	CI_RDB_GATEWAY		36  /* not used - to be retired */
