...
**	24-Feb-2010 (troal01)
**	    Map E_DM5423_SRID_MISMATCH to E_QE5423_SRID_MISMATCH
**	15-Mar-2010 (troal01)
**	    Add E_QE5424_INVALID_SRID and E_QE5425_SRS_NONEXISTENT as user
**	    errors so they get propagated to the user.
**	02-Apr-2010 (jonj)
...
# endif
    ...
    E_DM0200_MOD_TEMP_TABLE_KEY,    E_QE00A3_MOD_TEMP_TABLE_KEY,    2054,   0, 
    E_DM201E_SECURITY_DML_NOPRIV,   I_QE2033_SEC_VIOLATION,         6501,   0,
    E_DM201F_ROW_TABLE_LABEL,       I_QE2033_SEC_VIOLATION,         6502,   0,
    E_DM5423_SRID_MISMATCH,         E_QE5423_SRID_MISMATCH,         -1,     0,
    0L,                             E_QE5424_INVALID_SRID,          -1,     0,
    0L,                             E_QE5425_SRS_NONEXISTENT,       -1,     0,
