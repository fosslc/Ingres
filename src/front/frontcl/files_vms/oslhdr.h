...
##      29-feb-2008 (bolke01) b120021
##	    removed the signed qualifier from __int64 as it is not required.
##	    in the VMS definitions __uint64 is the unsigned version
##          and __int64 is always signed.
##   	    This chnage prevents the message %CC-I-SIGNEDKNOWN being reported
##  	    in the ABF window when using imageapp	 
