...
LONG CuDlgStatusDuplicatableComponent::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	try
	{
...
LONG CuDlgStatusDuplicatableComponent::OnComponentChanged (WPARAM wParam, LPARAM lParam)
{
	OnUpdateData (0, 0);
	return 0;
}
...
LONG CuDlgStatusDuplicatableComponent::OnNewEvents (WPARAM wParam, LPARAM lParam)
{
	//
...
LONG CuDlgStatusDuplicatableComponent::OnFindAccepted (WPARAM wParam, LPARAM lParam)
{
	return (LONG)TRUE;
}


LONG CuDlgStatusDuplicatableComponent::OnFind (WPARAM wParam, LPARAM lParam)
{
