...
#if !defined(AFX_PARINUSR_H__5D002665_94F4_11D2_A2B7_00609725DDAF__INCLUDED_)
#define AFX_PARINUSR_H__5D002665_94F4_11D2_A2B7_00609725DDAF__INCLUDED_
...
class CuDlgParameterInstallationUser : public CDialog
{
public:
	CuDlgParameterInstallationUser(CWnd* pParent = NULL);
	void OnOK(){return;}
	void OnCancel(){return;}
	void RefreshParameter(BOOL bShowUnset);

	// Dialog Data
	//{{AFX_DATA(CuDlgParameterInstallationUser)
	enum { IDD = IDD_PARAMETER_INSTALLATION_USER };
	...
	//{{AFX_VIRTUAL(CuDlgParameterInstallationUser)
	protected:
...
protected:
	...
	//{{AFX_MSG(CuDlgParameterInstallationUser)
...
#endif // !defined(AFX_PARINUSR_H__5D002665_94F4_11D2_A2B7_00609725DDAF__INCLUDED_)
