...
LONG CuDlgDomPropRoleXGrantedTbl::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LONG CuDlgDomPropRoleXGrantedTbl::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropRoleXGrantedTbl::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropRoleXGrantedTbl::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropRoleXGrantedTbl::RefreshDisplay()
{
  ...
  size = m_Data.m_uaRoleXGrantedTbl.GetCount();
  ASSERT (size > 0);
