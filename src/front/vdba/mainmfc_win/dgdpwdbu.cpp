...
LONG CuDlgDomPropIceDbuser::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
...
LONG CuDlgDomPropIceDbuser::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropIceDbuser::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropIceDbuser::OnGetData (WPARAM wParam, LPARAM lParam)
{
