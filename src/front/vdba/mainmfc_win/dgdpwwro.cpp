...
void CuDlgDomPropIceWebuserRoles::AddRole (CuNameOnly *pIceWebuserRoles)
{
  ...
  m_cListCtrl.SetItemData(index, (DWORD)pIceWebuserRoles);
}
...
LONG CuDlgDomPropIceWebuserRoles::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LONG CuDlgDomPropIceWebuserRoles::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropIceWebuserRoles::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropIceWebuserRoles::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropIceWebuserRoles::RefreshDisplay()
{
  ...
  size = m_Data.m_uaIceWebuserRoles.GetCount();
