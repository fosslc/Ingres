...
LONG CuDlgDomPropGroupXGrantedProc::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LONG CuDlgDomPropGroupXGrantedProc::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropGroupXGrantedProc::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropGroupXGrantedProc::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropGroupXGrantedProc::RefreshDisplay()
{
  ...
  size = m_Data.m_uaGroupXGrantedProc.GetCount();
  ASSERT (size > 0);
