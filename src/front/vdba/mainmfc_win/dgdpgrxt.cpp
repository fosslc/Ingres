...
LONG CuDlgDomPropGroupXGrantedTbl::OnQueryType(WPARAM wParam, LPARAM lParam)
{
  ASSERT (wParam == 0);
  ASSERT (lParam == 0);
  return DOMPAGE_LIST;
...
LONG CuDlgDomPropGroupXGrantedTbl::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropGroupXGrantedTbl::OnLoad (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDomPropGroupXGrantedTbl::OnGetData (WPARAM wParam, LPARAM lParam)
{
...
void CuDlgDomPropGroupXGrantedTbl::RefreshDisplay()
{
  ...
  size = m_Data.m_uaGroupXGrantedTbl.GetCount();
  ASSERT (size > 0);
