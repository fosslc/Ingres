...
//    Source   : gnrefpro.c
//
//    Dialog box for Executing procedure grant (Cross Reference)
//
** 10-Apr-2003 (schph01)
...
** 30-Oct-2003 (noifr01)
**  fixed propagation error in change 465722 for SIR 107523
********************************************************************/
...
BOOL CALLBACK __export DlgGnrefProcedureDlgProc
...
BOOL CALLBACK __export DlgGnrefProcedureDlgProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
   switch (message)
   {
