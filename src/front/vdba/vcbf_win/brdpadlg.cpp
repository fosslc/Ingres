...
LONG CuDlgBridgeParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgBridgeParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}

LONG CuDlgBridgeParameter::OnButton1 (UINT wParam, LONG lParam)
{
...
LONG CuDlgBridgeParameter::OnButton2(UINT wParam, LONG lParam)
{
...
LONG CuDlgBridgeParameter::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgBridgeParameter::OnButton3...\n");
	return 0;
}

LONG CuDlgBridgeParameter::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgBridgeParameter::OnButton4...\n");
	return 0;
}

LONG CuDlgBridgeParameter::OnButton5(UINT wParam, LONG lParam)
{
