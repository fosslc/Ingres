...
LONG CuDlgSecurityOption::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	//
	// First of all:
...
LONG CuDlgSecurityOption::OnButton1 (UINT wParam, LONG lParam)
{
...
LONG CuDlgSecurityOption::OnButton2(UINT wParam, LONG lParam)
{
...
LONG CuDlgSecurityOption::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgSecurityOption::OnButton3...\n");
	return 0;
}

LONG CuDlgSecurityOption::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgSecurityOption::OnButton4...\n");
	return 0;
}

LONG CuDlgSecurityOption::OnButton5(UINT wParam, LONG lParam)
{
