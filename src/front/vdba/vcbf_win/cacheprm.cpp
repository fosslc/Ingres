...
LONG CuDlgDbmsCacheParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgDbmsCacheParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}

LONG CuDlgDbmsCacheParameter::OnButton1 (UINT wParam, LONG lParam)
{
...
LONG CuDlgDbmsCacheParameter::OnButton2(UINT wParam, LONG lParam)
{
...
LONG CuDlgDbmsCacheParameter::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgDbmsParameter::OnButton3...\n");
	return 0;
}

LONG CuDlgDbmsCacheParameter::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgDbmsParameter::OnButton4...\n");
	return 0;
}

LONG CuDlgDbmsCacheParameter::OnButton5(UINT wParam, LONG lParam)
{
