...
LONG CuDlgLoggingSystemParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgLoggingSystemParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgLoggingSystemParameter::OnButton1 (UINT wParam, LONG lParam)
{
...
LONG CuDlgLoggingSystemParameter::OnButton2(UINT wParam, LONG lParam)
{
...
LONG CuDlgLoggingSystemParameter::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgLoggingSystemParameter::OnButton3...\n");
	return 0;
}

LONG CuDlgLoggingSystemParameter::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgLoggingSystemParameter::OnButton4...\n");
	return 0;
}

LONG CuDlgLoggingSystemParameter::OnButton5(UINT wParam, LONG lParam)
{
