...
LONG CuDlgRecoveryDerived::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LONG CuDlgRecoveryDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LONG CuDlgRecoveryDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgRecoveryDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgRecoveryDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgRecoveryDerived::OnButton3...\n");
	return 0;
}

LONG CuDlgRecoveryDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgRecoveryDerived::OnButton4...\n");
	return 0;
}

LONG CuDlgRecoveryDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
