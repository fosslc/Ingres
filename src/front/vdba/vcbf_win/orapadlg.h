...
//                                                                                     //
****************************************************************************************/
#if !defined(AFX_ORAPADLG_H__E51FBA52_328E_11D2_A29A_00609725DDAF__INCLUDED_)
#define AFX_ORAPADLG_H__E51FBA52_328E_11D2_A29A_00609725DDAF__INCLUDED_

#if _MSC_VER >= 1000
#pragma once
#endif // _MSC_VER >= 1000
// orapadlg.h : header file
//
#include "editlsgn.h"


class CuDlgGW_OracleParameter : public CDialog
{
public:
	CuDlgGW_OracleParameter(CWnd* pParent = NULL);
	void OnOK() {return;}
	void OnCancel() {return;}

	// Dialog Data
	//{{AFX_DATA(CuDlgGW_OracleParameter)
	...
	//{{AFX_VIRTUAL(CuDlgGW_OracleParameter)
	protected:
...
protected:
	...
	//{{AFX_MSG(CuDlgGW_OracleParameter)
...
#endif // !defined(AFX_ORAPADLG_H__E51FBA52_328E_11D2_A29A_00609725DDAF__INCLUDED_)
