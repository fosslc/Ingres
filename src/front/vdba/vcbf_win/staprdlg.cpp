...
**
**    Source   : staprdlg.cpp, Implementation File
...
CuDlgStarParameter::CuDlgStarParameter(CWnd* pParent)
	: CDialog(CuDlgStarParameter::IDD, pParent)
{
	//{{AFX_DATA_INIT(CuDlgStarParameter)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CuDlgStarParameter::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CuDlgStarParameter)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CuDlgStarParameter, CDialog)
	//{{AFX_MSG_MAP(CuDlgStarParameter)
	ON_WM_DESTROY()
	ON_WM_SIZE()
...
LONG CuDlgStarParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgStarParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
/////////////////////////////////////////////////////////////////////////////
// CuDlgStarParameter message handlers

void CuDlgStarParameter::PostNcDestroy() 
{
	delete this;
...
void CuDlgStarParameter::OnDestroy() 
{
...
void CuDlgStarParameter::OnSize(UINT nType, int cx, int cy) 
{
...
BOOL CuDlgStarParameter::OnInitDialog() 
{
...
LONG CuDlgStarParameter::OnButton1 (UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgStarParameter::OnButton1...\n");
	CRect r, rCell;
	UINT nState = 0;
	int iNameCol = 1;
	int iIndex = -1;
...
LONG CuDlgStarParameter::OnButton2(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgStarParameter::OnButton2...\n");
	UINT nState = 0;
	int iIndex = -1;
	int i, nCount = m_ListCtrl.GetItemCount();
	for (i=0; i<nCount; i++)
...
LONG CuDlgStarParameter::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgStarParameter::OnButton3...\n");
	return 0;
}

LONG CuDlgStarParameter::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgStarParameter::OnButton4...\n");
	return 0;
}

LONG CuDlgStarParameter::OnButton5(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgStarParameter::OnButton5...\n");
	return 0;
}


void CuDlgStarParameter::OnItemchangedList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
