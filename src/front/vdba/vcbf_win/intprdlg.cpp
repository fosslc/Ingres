...
LONG CuDlgInternetParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgInternetParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgInternetParameter::OnButton1 (UINT wParam, LONG lParam)
{
...
LONG CuDlgInternetParameter::OnButton2(UINT wParam, LONG lParam)
{
...
LONG CuDlgInternetParameter::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgInternetParameter::OnButton3...\n");
	return 0;
}

LONG CuDlgInternetParameter::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgInternetParameter::OnButton4...\n");
	return 0;
}

LONG CuDlgInternetParameter::OnButton5(UINT wParam, LONG lParam)
{
