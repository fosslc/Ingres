...
LONG CuDlgLoggingSystemDerived::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgLoggingSystemDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LONG CuDlgLoggingSystemDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgLoggingSystemDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgLoggingSystemDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgLoggingSystemDerived::OnButton3...\n");
	return 0;
}

LONG CuDlgLoggingSystemDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgLoggingSystemDerived::OnButton4...\n");
	return 0;
}

LONG CuDlgLoggingSystemDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
