...
LONG CuDlgSecurityAuditingDerived::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	if (!IsWindow (m_ListCtrl.m_hWnd))
		return 0;
...
LONG CuDlgSecurityAuditingDerived::OnButton1 (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgSecurityAuditingDerived::OnButton2(WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgSecurityAuditingDerived::OnButton3(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityAuditingDerived::OnButton3...\n");
	return 0;
}

LONG CuDlgSecurityAuditingDerived::OnButton4(WPARAM wParam, LPARAM lParam)
{
	TRACE0 ("CuDlgSecurityAuditingDerived::OnButton4...\n");
	return 0;
}

LONG CuDlgSecurityAuditingDerived::OnButton5(WPARAM wParam, LPARAM lParam)
{
