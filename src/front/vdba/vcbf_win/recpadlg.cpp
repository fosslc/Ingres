...
LONG CuDlgRecoveryParameter::OnButton1 (UINT wParam, LONG lParam)
{
...
LONG CuDlgRecoveryParameter::OnButton2(UINT wParam, LONG lParam)
{
...
LONG CuDlgRecoveryParameter::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgRecoveryParameter::OnButton3...\n");
	return 0;
}

LONG CuDlgRecoveryParameter::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgRecoveryParameter::OnButton4...\n");
	return 0;
}

LONG CuDlgRecoveryParameter::OnButton5(UINT wParam, LONG lParam)
{
...
LONG CuDlgRecoveryParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
	CWnd* pParent1 = GetParent ();              // CTabCtrl
	ASSERT_VALID (pParent1);
	CWnd* pParent2 = pParent1->GetParent ();    // CConfRightDlg
...
LONG CuDlgRecoveryParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
	m_ListCtrl.HideProperty();
	return 0L;
}