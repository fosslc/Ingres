...
** 
**    Source   : lksprdlg.cpp, Implementation File
...
CuDlgLockingSystemParameter::CuDlgLockingSystemParameter(CWnd* pParent)
	: CDialog(CuDlgLockingSystemParameter::IDD, pParent)
{
	//{{AFX_DATA_INIT(CuDlgLockingSystemParameter)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CuDlgLockingSystemParameter::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CuDlgLockingSystemParameter)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CuDlgLockingSystemParameter, CDialog)
	//{{AFX_MSG_MAP(CuDlgLockingSystemParameter)
	ON_WM_DESTROY()
	ON_WM_SIZE()
...
LONG CuDlgLockingSystemParameter::OnUpdateData (WPARAM wParam, LPARAM lParam)
{
...
LONG CuDlgLockingSystemParameter::OnValidateData (WPARAM wParam, LPARAM lParam)
{
...
/////////////////////////////////////////////////////////////////////////////
// CuDlgLockingSystemParameter message handlers

void CuDlgLockingSystemParameter::PostNcDestroy() 
{
	delete this;
...
void CuDlgLockingSystemParameter::OnDestroy() 
{
...
void CuDlgLockingSystemParameter::OnSize(UINT nType, int cx, int cy) 
{
...
BOOL CuDlgLockingSystemParameter::OnInitDialog() 
{
...
LONG CuDlgLockingSystemParameter::OnButton1 (UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgLockingSystemParameter::OnButton1...\n");
	CRect r, rCell;
	UINT nState = 0;
	int iNameCol = 1;
	int iIndex = -1;
...
LONG CuDlgLockingSystemParameter::OnButton2(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgLockingSystemParameter::OnButton2.(Restore)..\n");
	UINT nState = 0;
	int iIndex = -1;
	int i, nCount = m_ListCtrl.GetItemCount();
	for (i=0; i<nCount; i++)
...
LONG CuDlgLockingSystemParameter::OnButton3(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgLockingSystemParameter::OnButton3...\n");
	return 0;
}

LONG CuDlgLockingSystemParameter::OnButton4(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgLockingSystemParameter::OnButton4...\n");
	return 0;
}

LONG CuDlgLockingSystemParameter::OnButton5(UINT wParam, LONG lParam)
{
	TRACE0 ("CuDlgLockingSystemParameter::OnButton5...\n");
	return 0;
}


void CuDlgLockingSystemParameter::OnItemchangedList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
