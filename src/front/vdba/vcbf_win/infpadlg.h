...
//                                                                                     //
****************************************************************************************/
#if !defined(AFX_INFPADLG_H__E51FBA52_328E_11D2_A29A_00609725DDAF__INCLUDED_)
#define AFX_INFPADLG_H__E51FBA52_328E_11D2_A29A_00609725DDAF__INCLUDED_

#if _MSC_VER >= 1000
#pragma once
#endif // _MSC_VER >= 1000
// infpadlg.h : header file
//
#include "editlsgn.h"


class CuDlgGW_InformixParameter : public CDialog
{
public:
	CuDlgGW_InformixParameter(CWnd* pParent = NULL);
	void OnOK() {return;}
	void OnCancel() {return;}

	// Dialog Data
	//{{AFX_DATA(CuDlgGW_InformixParameter)
	...
	//{{AFX_VIRTUAL(CuDlgGW_InformixParameter)
	protected:
...
protected:
	...
	//{{AFX_MSG(CuDlgGW_InformixParameter)
...
#endif // !defined(AFX_INFPADLG_H__E51FBA52_328E_11D2_A29A_00609725DDAF__INCLUDED_)
