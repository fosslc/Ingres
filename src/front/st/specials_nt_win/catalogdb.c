...
**
**  Name: catalogdb.c -- Call catalogdb
**
**  Usage:
** 	catalogdb %1 %2 ...
**
**  Description:
**	This program provides the INGRES `catalogdb' command 
**	executing catalogdb and passing along any command line 
**	arguments including those with special characters e.g. =
** 
**  Exit Status:
**	OK	catalogdb succeeded.
**	FAIL	catalogdb failed.	
**
**  History:
**	02-Oct-1997 (mcgem01)
