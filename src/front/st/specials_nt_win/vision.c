...
**
**  Name: vision.c -- Call VISION
**
**  Usage:
** 	vision dbname %1 %2 ...
**
**  Description:
**	This program provides the INGRES `iiabf vision' command on '95 by 
**	executing vision passing along the command line arguments.
** 
**  Exit Status:
**	OK	vision succeeded.
**	FAIL	vision failed.	
