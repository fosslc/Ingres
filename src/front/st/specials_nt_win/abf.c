...
**
**  Description:
**	This program provides the INGRES `abf' command on '95 by 
**	executing iiabf abf and passing along the command line arguments.
** 
**  Exit Status:
**	OK	abf succeeded.
**	FAIL	abf failed.	
...
**              more control over the settings and the behavior of children.
**	20-feb-97 (mcgem01)
