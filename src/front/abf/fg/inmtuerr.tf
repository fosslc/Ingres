## -- inmtuerr.tf: Error handling (master in table field, insert & update
## --              operations)
##
...
##  ENDIF
    ...
    MESSAGE 'An error occurred while saving changes.'
          ...
          + ' message immediately preceding this one. The'
          + ' "Save" operation was not performed. Please'
          + ' correct the error and select "Save" again.'
 ...
 */
    MESSAGE 'The "Save" operation was not performed'
          + ' because the key column(s) for a master'
