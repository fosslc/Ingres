##  -- Master-only in simple fields BROWSE frame; template file 'msbrowse.tf'
##INCLUDE indoc.tf
##INCLUDE intopdef.tf
INITIALIZE (
...
##-- Add these menuitems to both singleton Select and Queries with Next:
    ...
    BEGIN
##      IF $singleton_select THEN
##      GENERATE HELP fgmsbnnp.hlp
##      ELSE
##      GENERATE HELP fgmsbxnp.hlp
##      ENDIF
    END
##
...
##-- Add these menuitems to both singleton Select and Queries with Next:
    ...
    BEGIN
##      IF $singleton_select THEN
##      GENERATE HELP fgmsbnqp.hlp
##      ELSE
##      GENERATE HELP fgmsbxqp.hlp
##      ENDIF
    END
