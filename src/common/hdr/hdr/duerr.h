...
**	    Add S_DU025A_SET_MAND_RELFLAGS, S_DU025B_MAKE_PHYSL_TBL_HASH,
**          S_DU045A_MAND_RELFLAGS_SET, S_DU045B_PHYSL_TBL_MADE_HASH,
**          S_DU1760_MAND_FLAGS_INCORRECT, S_DU1761_PHYSL_TBL_NOT_HASH,
...
#define			I_DU00A1_SERVER_CATS		(E_DUF_MASK + 0x00A1L)
...
#define			S_DU025A_SET_MAND_RELFLAGS	(E_DUF_MASK + 0x025AL)
#define			S_DU025B_MAKE_PHYSL_TBL_HASH	(E_DUF_MASK + 0x025BL)
...
#define			S_DU045A_MAND_RELFLAGS_SET	(E_DUF_MASK + 0x045AL)
#define			S_DU045B_PHYSL_TBL_MADE_HASH	(E_DUF_MASK + 0x045BL)
...
#define			S_DU1760_MAND_FLAGS_INCORRECT	(E_DUF_MASK + 0x1760L)
#define			S_DU1761_PHYSL_TBL_NOT_HASH	(E_DUF_MASK + 0x1761L)
...
#define			E_DU351D_INT_PASS_FAIL  	(E_DUF_MASK + 0x351DL)
...
#define			E_DU601B_CANT_SET_RELFLAGS	(E_DUF_MASK + 0X601BL)
#define			E_DU601C_CANT_MAKE_CATS_HASH	(E_DUF_MASK + 0X601CL)
