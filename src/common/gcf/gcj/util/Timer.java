...
**
** Description:
**	Defines a class for executing timed operations.
**
**  Classes
**
**	Timer		Extends java.lang.Thread
**
**  Interfaces
**
**	Callback
...
**	    Created.
**	11-Sep-02 (gordy)
**	    Minimize work done while synchronized.
*/
...
interrupt()
{
    ...
    if ( callback != null  &&  isAlive() )  super.interrupt();	
    return;
} // interrupt
