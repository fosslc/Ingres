...
$ if f$search("ing_src:[testtool.sep.''llbase_bin']setuser_dbg.exe").nes.""
$  then qasetuser   :== $ing_src:[testtool.sep.'llbase_bin']setuser_dbg.exe
$	qasetuserfe :== $ing_src:[testtool.sep.'llbase_bin']setuser_dbg.exe
$	qasetusertm :== $ing_src:[testtool.sep.'llbase_bin']setuser_dbg.exe
$  else
$	if f$search("ing_src:[bin]setuser_dbg.exe").nes.""
$	   then qasetuser   :== $ing_src:[bin]setuser_dbg.exe
$		qasetuserfe :== $ing_src:[bin]setuser_dbg.exe
$		qasetusertm :== $ing_src:[bin]setuser_dbg.exe
$	endif
$ endif
$ if f$search("ing_src:[testtool.sep.''llbase_bin']septool_dbg.exe").nes.""
$  then sep31 := $ing_src:[testtool.sep.'llbase_bin']septool_dbg.exe
$  else if f$search("ing_src:[bin]septool_dbg.exe").nes.""
$	   then sep31 := $ing_src:[bin]septool_dbg.exe
$	endif
$ endif
