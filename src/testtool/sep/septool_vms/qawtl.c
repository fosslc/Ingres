...
**
** For OpenVMS, define QAWTL_LOG logical as follows:
**     DEFINE   QAWTL_LOG   <path_of_my_log_file>
**              (for example)
**     DEFINE   QAWTL_LOG   II_SYSTEM:[ingres.files]mylog.log
**
** If you want to disable these messages all together:
** setenv QAWTL_LOG /dev/null
**
** To disable these messages on OpenVMS, define the logical as follows:
**     DEFINE   QAWTL_LOG   NLA0:
**
