...
/*{
** Name:	BTor -- 'or' two byte streams
**
** Description:
**		Perform C 'or' operation (|) on byte streams
**
** Inputs:
**	size		number of bits of byte streams to 'or'
**	vector1,
**	vector2		byte streams to 'or'
**
** Outputs:
**	vector2		result of 'or'ing vector1 and vector2
**
**	Returns:
**		None
**	Exceptions:
...
**	5-Aug-2004 (schka24)
**	    Copy code-bums from btand: eliminate old special-casing,
**	    use i8-at-a-time where available.
*/
...

{
	  ...
	  && ((SCALARP)vector1 & 7) == 0 && ((SCALARP)vector2 & 7) == 0 )
		...
		*l2 |= *l1;
		...
		register u_i4 lnum;    /*  Must 'or' 'lnum' longs  */
	  ...
	  && ((SCALARP)vector1 & 3) == 0 && ((SCALARP)vector2 & 3) == 0 )
		...
		*w2 |= *w1;
		...
		register u_i4 wnum;    /*  Must 'or' 'wnum' words  */
